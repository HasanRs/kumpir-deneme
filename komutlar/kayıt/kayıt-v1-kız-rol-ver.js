...
exports.run = (client, message, args) => {
    ...
    let rol1 = db.get(`kayıt_erkek.verilecek.${message.guild.id}`);
    ...
    db.set(`kayıt_kız.verilecek.${message.guild.id}`, rol.id);
...
exports.help = {
    name: 'kız-rol-ver',
    description: 'Kayıt sisteminde verilecek kız rolünü ayarlar.',
    usage: 'kız-rol-ver @rol',
};
